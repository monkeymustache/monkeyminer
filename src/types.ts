...
export type MonkeyMinerRequest = {
  type: string;
  params: MonkeyMinerLoginParams | MonkeyMinerJob;
};

export type MonkeyMinerLoginParams = {
  site_key: string;
  user: string | null;
};

export type MonkeyMinerJob = Job;

export type MonkeyMinerResponse = {
  type: string;
  params: MonkeyMinerLoginResult | MonkeyMinerSubmitResult | MonkeyMinerJob | MonkeyMinerError;
};

export type MonkeyMinerLoginResult = {
  hashes: number;
  token: string | null;
};

export type MonkeyMinerSubmitResult = {
  hashes: number;
};

export type MonkeyMinerError = {
  error: string;
};
